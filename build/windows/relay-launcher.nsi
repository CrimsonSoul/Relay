...
BrandingText "Relay"
VIProductVersion "${RELAY_LAUNCHER_GENERATION}.0.0.0"
...
VIAddVersionKey /LANG=1033 "FileVersion" "${RELAY_LAUNCHER_GENERATION}.0.0.0"
VIAddVersionKey /LANG=1033 "ProductVersion" "${RELAY_LAUNCHER_GENERATION}.0.0.0"
