...
export const Combobox: React.FC<ComboboxProps> = ({
    ...
    const filteredOptions = useMemo(() => {
        ...
        const exactMatch = options.some(o => o.label.toLowerCase() === lower || o.value.toLowerCase() === lower);
            ...
            {isOpen && (filteredOptions.length > 0 || !value) && (
                <div style={{
                    ...
                    {filteredOptions.length > 0 ? (
                        ...
                        <div style={{ padding: '8px 12px', fontSize: '13px', color: 'var(--color-text-tertiary)', fontStyle: 'italic' }}>
                            No matches
                        </div>
                    )}
                </div>
