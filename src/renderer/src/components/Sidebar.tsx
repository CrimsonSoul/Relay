  ...
  return (
    ...
    >
      ...
      <div
        ...
        onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); onTabChange("Compose"); } }}
      ...
      <div style={{ width: "36px", height: "1px", background: "linear-gradient(90deg, transparent, rgba(255, 255, 255, 0.08), transparent)", marginBottom: "8px", flexShrink: 0 }} />
      ...
      <div style={{ WebkitAppRegion: "no-drag", display: "flex", flexDirection: "column", gap: "14px" }}>
        <SidebarButton
          label="Settings"
          isActive={false}
