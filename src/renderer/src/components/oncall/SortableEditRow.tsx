...
export const SortableEditRow: React.FC<SortableEditRowProps> = ({ row, contacts, onUpdate, onRemove }) => {
  ...
  return (
    <div ref={setNodeRef} style={style}>
      <div style={{ display: "grid", gridTemplateColumns: "30px 140px 1fr 140px 120px 30px", gap: "12px", alignItems: "center", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.05)", padding: "12px", borderRadius: "12px", transition: "background 0.2s" }}
        ...
        <div style={{ cursor: "pointer", color: "var(--color-danger)", opacity: 0.6, textAlign: "center", display: "flex", alignItems: "center", justifyContent: "center", width: "24px", height: "24px", borderRadius: "50%", transition: "all 0.2s" }}
