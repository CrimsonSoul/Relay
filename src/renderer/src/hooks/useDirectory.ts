...
export function useDirectory(
  ...
  const handleCreateContact = (contact: Partial<Contact>) =>
  ...
  return {
    ...
    contextMenu,
    setContextMenu,
    editingContact: contactOps.editingContact,
    setEditingContact: contactOps.setEditingContact,
    deleteConfirmation: contactOps.deleteConfirmation,
    setDeleteConfirmation: contactOps.setDeleteConfirmation,
    groupSelectorContact,
    setGroupSelectorContact,
    handleCreateContact,
    handleUpdateContact: contactOps.handleUpdateContact,
    handleDeleteContact: contactOps.handleDeleteContact,
    handleAddWrapper,
    groupMap,
  };
}
