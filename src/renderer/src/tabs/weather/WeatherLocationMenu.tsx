              ...
              {savedLocations.map((saved) => (
                <div key={saved.id} className="weather-saved-location-item">
                  ...
                  <div className="weather-saved-item-actions">
                    <Tooltip content={`Rename ${saved.name}`}>
                      <button
                        type="button"
                        onClick={(e) => {
                          e.stopPropagation();
                    ...
                    {saved.isDefault ? (
                      <Tooltip content={`Remove ${saved.name} as default`}>
                        <button
                          type="button"
                          onClick={(e) => {
                            e.stopPropagation();
                      ...
                      <Tooltip content={`Set ${saved.name} as default`}>
                        <button
                          type="button"
                          onClick={(e) => {
                            e.stopPropagation();
                    ...
                    <Tooltip content={`Delete ${saved.name}`}>
                      <button
                        type="button"
                        onClick={(e) => {
                          e.stopPropagation();
