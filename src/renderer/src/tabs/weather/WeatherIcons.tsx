...
const commonProps = {
  width: 24, height: 24, viewBox: "0 0 24 24", fill: "none", strokeWidth: 2,
  strokeLinecap: "round" as "round", strokeLinejoin: "round" as "round", style: { overflow: "visible" as const },
};
...
export const getWeatherIcon = (code: number, size = 24) => {
    ...
    return (
      <svg {...props} stroke="currentColor">
        <g stroke="#FDB813">
          ...
          <line x1="16" y1="1" x2="16" y2="2.5" /><line x1="21.5" y1="2.5" x2="20.5" y2="3.5" /><line x1="23" y1="8" x2="21.5" y2="8" />
        </g>
  ...
  if (code === 3 || code === 45 || code === 48) {
    return (
      <svg {...props} stroke="#A1A1AA">
        ...
        {(code === 45 || code === 48) && <><line x1="6" y1="22" x2="18" y2="22" strokeOpacity="0.5" /><line x1="8" y1="25" x2="16" y2="25" strokeOpacity="0.3" /></>}
      </svg>
    );
  }
  ...
  if ((code >= 51 && code <= 67) || (code >= 80 && code <= 82)) {
    return (
      <svg {...props} stroke="#60A5FA">
        ...
        <line x1="8" y1="21" x2="8" y2="24" /><line x1="12" y1="21" x2="12" y2="24" /><line x1="16" y1="21" x2="16" y2="24" />
      </svg>
    );
  }
    ...
    return (
      <svg {...props} stroke="#E5E7EB">
        ...
        <g transform="translate(0, 2)">
          <line x1="8" y1="21" x2="8" y2="21.01" strokeWidth="3" /><line x1="12" y1="21" x2="12" y2="21.01" strokeWidth="3" /><line x1="16" y1="21" x2="16" y2="21.01" strokeWidth="3" />
        </g>
      </svg>
    );
  }
  ...
  // Default / Cloudy
  return <svg {...props} stroke="#A1A1AA"><path d={cloudPath} /></svg>;
};
