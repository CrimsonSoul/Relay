...
const api: BridgeAPI = {
  ...
  saveAndOpenEml: (content) => ipcRenderer.invoke(IPC_CHANNELS.EML_SAVE_AND_OPEN, content),
  saveAndOpenEmlInOutlook: (content) =>
    ipcRenderer.invoke(IPC_CHANNELS.EML_SAVE_AND_OPEN_OUTLOOK, content),
  // Schedule Bridge (.ics)
